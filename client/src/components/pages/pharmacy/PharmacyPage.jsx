    ...
    <div className="flex h-screen bg-gray-50 relative">
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-6 bg-white text-blue-800 rounded-full p-1 shadow-md hover:bg-gray-100 hidden sm:block"
        >
          <FiChevronLeft
        ...
        <div className="flex flex-col items-center pt-6 pb-4 border-b border-blue-700">
          {!sidebarCollapsed && (
            <>
              ...
              <div className="flex items-center w-full px-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-blue-300">Pharmacy</p>
                </div>
              </div>
            </>
          )}
